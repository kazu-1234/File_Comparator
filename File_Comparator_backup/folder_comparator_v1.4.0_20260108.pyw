...
# 作成日: 2025-12-23
"""
Folder Comparison Tool (GUI Version) v1.4.0
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("フォルダ差分チェックツール v1.4.0")
    ...
    def _create_widgets(self):
        ...
        ttk.Label(header_frame, text="不足ファイル検索ツール", style="Header.TLabel").pack(side=tk.LEFT)
